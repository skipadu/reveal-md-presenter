...
export default class RevealMdPresenterUI extends React.Component {
  ...
  async showPresenterWindow() {
    ...
    // const whichResult = exec('which reveal-md', function (
    //   error,
    //   stdout,
    //   stderr
    // ) {
    //   if (error) {
    //     console.log('Error when tried to find location of reveal-md', error);
    //   }
    //   console.log('which STDOUT:', stdout);
    //   console.log('which STDERR:', stderr);
    // });
    // whichResult.on('exit', function (code) {
    //   console.log('which exited with exit code: ', code);
    // });
    //
    //
